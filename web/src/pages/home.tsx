  ...
  return (
    <div>
      ...
      <div className={username ? "flex gap-2 bg-primary" : "hidden"} style={{flexDirection: "column", position: "absolute", top: "40%", left: "50%", transform: "translate(-50%, -50%)", borderRadius: "1rem", padding: "3rem"}}>
          <Button className="btn btn-secondary" style={{width: "15rem"}} onClick={() => window.location.href = "/sheets/view"}>Create Sheet</Button>
          <Button className="btn btn-secondary" style={{width: "15rem"}} onClick={() => window.location.href = "/campaigns/view"}>Create Campaign</Button>
